...
A web platform for a digital used bookstore, focusing on UI/UX, responsiveness, and dynamic content.

🔗 [View repository](https://github.com/cauagreccodev/Sebo-digital-site)
...
A robust date validation system built to demonstrate core Object-Oriented Programming (OOP) concepts, encapsulation, and clean architecture.

🔗 [View repository](https://github.com/cauagreccodev/Date-validation-system)
