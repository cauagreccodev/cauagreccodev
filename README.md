...
**`Backend Developer in Training · PUC-Campinas · Jaguariúna, SP — Brazil`**

Computer Information Systems student passionate about building things that actually work — from REST APIs with FastAPI to calculators written in MIPS Assembly. I'm constantly exploring languages, data structures, and databases, always pushing beyond what's required in class.
...
class Cauã:
    ...
    languages   = ["Portuguese 🇧🇷 (Native)", "English 🇺🇸 (Upper-Intermediate — CNA)"]
    studying    = ["Assembly", "C / C++", "Python", "Dart", "HTML & CSS", "SQL", "Lua"]
    focus       = ["Backend Development", "REST APIs", "Data Structures", "Databases"]
    looking_for = "IT Internship / Backend Development"
...
![Assembly](https://img.shields.io/badge/Assembly_MIPS-6E4C13?style=for-the-badge&logoColor=white)
...
A university integrative project built in Dart, exploring interactive application development and game logic.

---

### [Studies](https://github.com/cauagreccodev/Estudos)
> **Continuous learning repository** — `Python` · `C` · `C++` · `Assembly` · `Dart` · `HTML/CSS` · `SQL` · `Lua`

My central learning hub for both university coursework and self-directed study. Covers OOP, Data Structures, SQL CRUD, mobile development with Dart, front-end basics with HTML & CSS, and more.
...
![Cauã's GitHub Stats](https://github-readme-stats.vercel.app/api?username=cauagreccodev&show_icons=true&theme=tokyonight&hide_border=true&include_all_commits=true&count_private=true)
...
| CNA Language School | English — Upper-Intermediate/Advanced | Completed |
...
### Open to IT internship and Backend Development opportunities!
